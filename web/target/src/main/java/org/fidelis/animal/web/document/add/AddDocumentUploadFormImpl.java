 ...
 */
public class AddDocumentUploadFormImpl
    implements Serializable, AddForm, CheckRecordTypeForm
{
    /**
     * Default constructor
     */
    public AddDocumentUploadFormImpl()
    {
    }

    // Action add-document-upload formFields
    private Long id;
     ...
     */     
     public AddDocumentUploadFormImpl copyFrom(Map<String,Object> source)
    {
     ...
     */
    private static final long serialVersionUID = 158923838190361171L;
}