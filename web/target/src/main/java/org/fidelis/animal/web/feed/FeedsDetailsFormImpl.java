 ...
 */
public class FeedsDetailsFormImpl
    implements Serializable, LoadForm
{
    /**
     * Default constructor
     */
    public FeedsDetailsFormImpl()
    {
    }

    // Action manage-feeds-details formFields
    @NotNull
    private String name;
     ...
     */     
     public FeedsDetailsFormImpl copyFrom(Map<String,Object> source)
    {
     ...
     */
    private static final long serialVersionUID = -8228917510483260090L;
}