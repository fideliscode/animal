 ...
 */
public class AddAnimalFormImpl
    implements Serializable, LoadOptionsForm
{
    /**
     * Default constructor
     */
    public AddAnimalFormImpl()
    {
    }

    // Action add-animal-load-options formFields
     ...
     */     
     public AddAnimalFormImpl copyFrom(Map<String,Object> source)
    {
     ...
     */
    private static final long serialVersionUID = 4621509435545020426L;
}