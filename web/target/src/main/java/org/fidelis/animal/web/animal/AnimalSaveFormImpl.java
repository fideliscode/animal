 ...
 */
public class AnimalSaveFormImpl
    implements Serializable, EditForm, LoadForm
{
    /**
     * Default constructor
     */
    public AnimalSaveFormImpl()
    {
    }

    // Action manage-animals-save formFields
    private Long id;
     ...
     */     
     public AnimalSaveFormImpl copyFrom(Map<String,Object> source)
    {
     ...
     */
    private static final long serialVersionUID = -1065429946854851372L;
}