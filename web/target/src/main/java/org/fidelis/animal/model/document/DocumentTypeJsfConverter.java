...
/**
 * Handles conversion of the enumeration {@link DocumentType}
 * to a String and back.
 */
public class DocumentTypeJsfConverter
    implements Converter
{
    ...
    {
        return (value == null || value.toString().trim().length() == 0) ? "":  ((DocumentType)value).toString();
    }
    ...
    public Object getAsObject(
        ...
        throws ConverterException
    {
        return value != null && value.trim().length() > 0 ? DocumentType.fromString(value) : null;
    }
}