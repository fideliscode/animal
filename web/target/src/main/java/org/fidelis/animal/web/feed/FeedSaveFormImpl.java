 ...
 */
public class FeedSaveFormImpl
    implements Serializable, EditForm, LoadForm
{
    /**
     * Default constructor
     */
    public FeedSaveFormImpl()
    {
    }

    // Action manage-feeds-save formFields
    private Long id;
     ...
     */     
     public FeedSaveFormImpl copyFrom(Map<String,Object> source)
    {
     ...
     */
    private static final long serialVersionUID = 5976951408286250795L;
}